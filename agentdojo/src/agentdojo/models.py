...
class ModelsEnum(StrEnum):
    ...
    GEMINI_2_0_FLASH_001_OPENROUTER = "google/gemini-2.0-flash-001"
...
MODEL_PROVIDERS = {
    ...
    ModelsEnum.ANTHROPIC_CLAUDE_SONNET_4_5: "openrouter",
    ...
    ModelsEnum.GEMINI_2_0_FLASH_001_OPENROUTER: "openrouter",
...
MODEL_NAMES = {
    ...
    "gpt-5-nano": "GPT-5",
    "gpt-5": "GPT-5",
    "meta-llama/Llama-3.1-70B-Instruct": "AI assistant",
